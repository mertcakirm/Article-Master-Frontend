    ...
    return (
        ...
        <div className="popup-content">
                    ...
                    <svg viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g id="Group-2" transform="translate(2.000000, 2.000000)">
                                <circle id="Oval-2" stroke="rgba(252, 191, 191, .5)" strokeWidth="4" cx="41.5"
                                        cy="41.5" r="41.5"></circle>
                                <circle className="ui-error-circle" stroke="#F74444" strokeWidth="4" cx="41.5"
                                        cy="41.5" r="41.5"></circle>
            ...
            <div className="row w-100 p-0 m-0 justify-content-center">
                <p className="col-12 text-center" style={{color: '#fff'}}>{infoText}</p>
