    ...
    return (
        <div className="popup-overlay">
            <div className="popup-content popup-content-note" style={{color: '#fff'}} data-aos="zoom-in">
                ...
                <div className="note-table mb-3">
                    <table className="table table-striped table-dark text-center note-table">
                        <thead>
                        <tr>
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <div className="my-notes-process-flex">
                                            <Link style={{background: 'orange'}} to={`/article/${note.articleId}`}
                                                  className="my-notes-process-see">
                                                <svg clipRule="evenodd" fill="white" width="30" height="30"
                                            ...
                                            <button style={{background: 'red'}}
                                                    onClick={() => toggleProcessPopup('note_delete', note.id, "Are you sure you want to delete your notes for this article?")}
