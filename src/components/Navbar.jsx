        ...
        <div className="container-fluid nav-con py-2" data-aos="fade-in">
            <div className="row align-items-center nav-row-lg">
                <div className="col-lg-3 p-0 align-items-center row">
                    <Link to="/" className="col-lg-1 p-0 navbar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="200" viewBox="0 0 600 200">
                            <path d="M120,60 L220,60 L220,140 L120,140 Z" fill="#FFFFFF" stroke="#4A235A"
                                  strokeWidth="1"/>
                            <path d="M120,60 L120,140 L140,120 L140,80 Z" fill="#F8F9F9" stroke="#4A235A"
                                  strokeWidth="1"/>
                ...
                <div className="nav-lg-flex align-items-center justify-content-end column-gap-3 col-lg-9 m-0">
                    ...
                    <Link to="/articles"
                          className={` navbar-link ${url === "articles" ? "active-nav-link" : ""}`}>Articles</Link>
                    ...
                    {token ? (
                        <>
                            ...
                            <Link to="/favorites"
                                  className={` navbar-link ${url === "favorites" ? "active-nav-link" : ""}`}>
                                Favorites
                            </Link>
                            <Link to="/my-notes"
                                  className={`navbar-link ${url === "my-notes" ? "active-nav-link" : ""}`}>
                                Notes
                            </Link>
                            ...
                            {role === "ADMIN" && (
                                <Link to="/admin"
                                      className={` navbar-link ${url === "admin" ? "active-nav-link" : ""}`}>
                                    Admin
                                </Link>
                            )}
                            <button
