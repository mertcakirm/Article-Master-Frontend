                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <div className="my-notes-process-flex">
                                            <Link style={{background: 'orange'}} to={`/article/${favorite.id}`}
                                            ...
                                            <button style={{background: 'red'}}
                                                    onClick={() => toggleProcessPopup('article_favorite', favorite.id, "Are you sure you want to delete this article from your favorites list?")}
                                                    className="my-notes-process-bin">
                                                <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round"
                                                     strokeMiterlimit="2" width="30" height="30" fill="white"
                                                     viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path
