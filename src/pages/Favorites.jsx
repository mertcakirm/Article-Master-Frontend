                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="my-notes-process-flex">
                                        ...
                                        <button style={{background:'red'}} onClick={()=>toggleProcessPopup('article_favorite',1,"Are you sure you want to delete this article from your favorites list?","Transaction successful")} className="my-notes-process-bin">
