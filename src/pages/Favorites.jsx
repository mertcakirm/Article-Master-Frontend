        ...
        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="my-notes-process-flex">
                                        <button className="my-notes-process-see">
            ...
            {isProcessPopupOpen && (
                <ProcessPopup
                    ...
                    text="Bu makaleyi favori listenizden silmek istediğinize emin misiniz?"
                    acceptedText="Favorilenmiş makale başarıyla silindi"
                    type="offer_delete"
                    id="1"
                />
            )}
