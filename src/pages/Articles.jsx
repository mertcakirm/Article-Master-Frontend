                                ...
                                <a href={`/article/${article.id}`} className="article-card">
                                    ...
                                    <div className="my-notes-process-flex justify-content-between w-100 px-5">
                                        <div className="my-notes-process-flex align-items-center">
                                            <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" width="30" fill="white" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="my-notes-process-flex align-items-center">
                                            ...
                                            <div>{article.ratingOverall} /10</div>
                                        </div>
                                    </div>
                                </a>
                                <button className="article-card-like">
                                    <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" width="30" height="30" fill="red" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
