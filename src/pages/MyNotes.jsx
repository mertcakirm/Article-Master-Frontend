                            ...
                            <tr>
                                ...
                                <td>
                                    <div className="my-notes-process-flex">
                                        ...
                                        <button onClick={()=>toggleProcessPopup('note_delete',1,"Are you sure you want to delete your notes for this article?","Transaction successful")} className="my-notes-process-bin">
