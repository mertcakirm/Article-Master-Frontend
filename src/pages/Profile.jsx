                ...
                <div className="col-xl-6 row justify-content-center">
                    <div className="col-lg-9 col-12">
                        ...
                        <div className="profile_card row justify-content-between p-3 mt-5" data-aos="fade-up">
                            ...
                            <div className="col-lg-7 col-12 justify-content-center align-items-start row-gap-3"
                                ...
                                {role !== "USER" && (
                                    <>
                                        <div className="w-100 row justify-content-between align-items-center p-0 m-0">
                                            ...
                                            <div
                                                className="col-3 profile-card-right-value">{userData.articleCount}</div>
                                        </div>
                                        <div className="w-100 row justify-content-between align-items-center  p-0 m-0">
                                            <div className="col-9 profile-card-right-key">Writer Rating</div>
                                            <div
                                                className="col-3 profile-card-right-value">{userData.ratingOverall}</div>
                                        </div>
                                        <div className="w-100 row justify-content-between align-items-center  p-0 m-0">
                                ...
                                <button onClick={toggleUpdatePopup} className="my-notes-process-see col-12">Update Other
                                    Information
                                </button>
                            </div>
                        </div>
